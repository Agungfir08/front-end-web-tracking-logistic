      ...
      <div className="bg-white rounded-lg px-8 py-6 flex flex-col w-[320px] h-[440px] md:w-[400px] md:h-[500px] justify-between">
        <div className="mt-6">
          <Stepper
            ...
            <Step
              className=" w-14 h-14 bg-gray-100 outline outline-3 outline-gray-500 text-gray-500"
              ...
              <div className="absolute -bottom-[2.3rem] w-max text-center text-base font-medium">
                <h6>Entry</h6>
              </div>
            </Step>
            <Step
          ...
          <Timeline>
            <TimelineItem className=" h-16">
              ...
              <TimelineHeader className="h-3">
                ...
                <div className="flex justify-between w-full items-center">
                  <p className=" text-sm w-fit">Dimasukkan dalam sistem</p>
            ...
            <TimelineItem className=" h-16">
              ...
              <TimelineHeader className="h-3">
                ...
                <div className="flex justify-between w-full items-center">
                  <p className=" text-sm w-fit">Dalam proses pengecekan</p>
                  <p className=" text-sm text-end">
                    2023-07-27
                    <br />
                    14:20:29
            ...
            <TimelineItem className=" h-16">
              ...
              <TimelineHeader className="h-3">
                ...
                <div className="flex justify-between w-full items-center">
                  <p className=" text-sm w-fit">Dalam Perjalan [IMRAN]</p>
                  <p className=" text-sm text-end">
                    2023-07-27
                    <br />
                    14:20:29
            ...
            <TimelineItem className="h-16">
              <TimelineHeader className="h-3">
                ...
                <div className="flex justify-between w-full items-center">
                  <p className=" text-sm">Diterima Oleh [Rian]</p>
                  <p className=" text-sm text-end">
                    2023-07-27
                    <br />
                    14:20:29
